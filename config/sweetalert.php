...
return [
    ...
    */
    ...
    | you set alert/toast by using the facade/helpers functions.
    */
    ...
    | For specific modal just use the autoClose() helpers method.
    |
    */
    ...
    | This is for the all Modal windows.
    | for particular modal just use the width() helpers method.
    */
    ...
    */
    ...
    | This is for the all Modal windows.
    | for particular modal just use the padding() helpers method.
    */
    ...
    | For specific modal just use the animation() helpers method.
    |
    */
    ...
    | This is for the all Modal windows.
    | For specific modal just use the showConfirmButton() helpers method.
    |
    */
    ...
    | This is for the all Modal windows.
    | For specific modal just use the showCloseButton() helpers method.
    |
    */
    ...
    | For specific modal just use the position() helpers method.
    |
    */
